...
class PriorityQueue():
    ...
    def get_priority(self, item):
        return self._minheap[self._item_to_index_map[item]].priority

    def has_item(self, item):
        return item in self._item_to_index_map
